...
import RestrictedDeployFormFields from "./DeployFormFields/RestrictedDeployFormFields";
...
const RestrictedDeploySchema = Yup.object().shape({
...
export const RestrictedDeployForm = ({
  ...
  return (
    <ActionForm<DeployFormValues, MachineEventErrors>
      ...
      validationSchema={RestrictedDeploySchema}
    >
      <RestrictedDeployFormFields />
    </ActionForm>
  );
};

export default RestrictedDeployForm;
